...
def index(request):  
    ...
    countrySummary=result.json()['Countries']
    india=[item for item in countrySummary if item["Country"] == "India"][0]
    

    result2=requests.get("https://api.covid19india.org/state_district_wise.json")
